...
export default function Home() {
  return (
    <div>
      <Navbar />
      <div className="mt-20 w-full bg-gradient-to-b from-white to-[#c0def3] flex flex-col font-sans h-[70vh]">
          ...
          <div className="w-full md:w-2/5 bg-white bg-opacity-70 border border-gray-200 rounded-lg p-6 shadow-lg">
            <Card className="max-w-full border-none bg-transparent shadow-none">
              ...
              <p className="font-normal text-gray-700 dark:text-gray-400">
                ...
                parte de tu formación, contribuyes realizando horas de servicio
                que benefician a la comunidad y apoyan a la institución. Estas
                horas no solo son una forma de retribuir, sino que también
                representan un método significativo de pago por tu curso. A
                través de este modelo, adquieres experiencia práctica,
                desarrollas responsabilidad y ayudas a que la educación sea más
