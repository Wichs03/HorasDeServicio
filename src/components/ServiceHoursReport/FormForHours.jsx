  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <form
        ...
        <button
          type="submit"
          className="bg-blue-600 text-white mt-5 py-2 px-4 rounded hover:bg-blue-700 disabled:bg-gray-400 drop-shadow-[0_0_5px_rgba(0,50,255,0.3)] hover:drop-shadow-[0_0_5px_rgba(0,50,255,0.6)] transition-all duration-300 cursor-pointer"
          disabled={loading}>
